...
const (
	WalManager_ArchiveWal_FullMethodName = "/adapter.v1.WalManager/ArchiveWal"
	WalManager_RestoreWal_FullMethodName = "/adapter.v1.WalManager/RestoreWal"
)
...
func (c *walManagerClient) ArchiveWal(ctx context.Context, in *ArchiveWalRequest, opts ...grpc.CallOption) (*ArchiveWalResult, error) {
	...
	err := c.cc.Invoke(ctx, WalManager_ArchiveWal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walManagerClient) RestoreWal(ctx context.Context, in *RestoreWalRequest, opts ...grpc.CallOption) (*RestoreWalResult, error) {
	...
	err := c.cc.Invoke(ctx, WalManager_RestoreWal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WalManager_ArchiveWal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalManager_ArchiveWal_FullMethodName,
	}
...
func _WalManager_RestoreWal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalManager_RestoreWal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	BackupManager_Backup_FullMethodName = "/adapter.v1.BackupManager/Backup"
)
...
func (c *backupManagerClient) Backup(ctx context.Context, in *BackupRequest, opts ...grpc.CallOption) (*BackupResult, error) {
	out := new(BackupResult)
	err := c.cc.Invoke(ctx, BackupManager_Backup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBackupManagerServer) Backup(context.Context, *BackupRequest) (*BackupResult, error) {
...
func _BackupManager_Backup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackupManagerServer).Backup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackupManager_Backup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackupManagerServer).Backup(ctx, req.(*BackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackupManager_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "adapter.v1.BackupManager",
	HandlerType: (*BackupManagerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Backup",
			Handler:    _BackupManager_Backup_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "adapter/adapter.proto",
